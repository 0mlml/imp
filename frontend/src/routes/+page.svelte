...
<div class="min-h-screen flex flex-col items-center justify-center bg-gray-50 text-gray-800">
    ...
    {:else}
        ...
        <div class="border border-gray-300 bg-white p-4 rounded shadow-xl mb-6 w-72">
            <!-- position -->
            <h2 class="font-bold text-lg mb-2 text-center">Position</h2>
            <p class="mb-2">
                <span class="font-bold italic">X:</span>
                {processedData.x.toFixed(2)} m/s²
            </p>
            <p class="mb-2">
                <span class="font-bold italic">Y:</span>
                {processedData.y.toFixed(2)} m/s²
            </p>
            <p class="mb-2">
                <span class="font-bold italic">Z:</span>
                {processedData.z.toFixed(2)} m/s²
            </p>
            <p>
                <span class="font-bold italic">Still:</span>
                {processedData.isMotionStill}
            </p>
        </div>
        ...
        <div class="border border-gray-300 bg-white p-4 rounded shadow-xl mb-6 w-72">
            ...
            <p class="mb-2">
                <span class="font-bold italic">Temperature:</span>
                {processedData.temperature.toFixed(2)} °C
            </p>
            <p class="mb-2">
                <span class="font-bold italic">Humidity:</span>
                {processedData.humidity.toFixed(2)} %
            </p>
        </div>
        ...
        <div class="border border-gray-300 bg-white p-4 rounded shadow-xl mb-6 w-72">
            ...
            <p class="mb-2">
                <span class="font-bold italic">eTemperature:</span>
                {processedData.environmentalTemperature.toFixed(2)} °C
            </p>
            <p class="mb-2">
                <span class="font-bold italic">eHumidity:</span>
                {processedData.environmentalHumidity.toFixed(2)} %
            </p>
            <p>
                <span class="font-bold italic">Peak Acceleration:</span>
                {processedData.peak_acceleration.toFixed(2)} m/s²
            </p>
        </div>
    {/if}
